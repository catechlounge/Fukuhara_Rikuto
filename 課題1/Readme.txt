...
これらの前処理手法を組み合わせて11層の深層ニューラルネットワークモデルを訓練しましたが、平均絶対誤差（MAE）が0.4502となり、これはランダムフォレストで作成したモデルよりも精度が低くなってしまいました。次のステップとして、この誤差を減らすための方法を探るべく、CA Tech Loungeで専門家のアドバイスをいただき、より良い深層学習モデルを作成していきたいと考えています。